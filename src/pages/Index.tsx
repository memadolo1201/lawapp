...
const Index = () => {
  ...
  const [stats, setStats] = useState([
    { title: "إجمالي العملاء", value: "0", icon: Users },
    { title: "القضايا النشطة", value: "0", icon: Briefcase },
    { title: "المستندات", value: "0", icon: FileText },
    { title: "الإيرادات", value: "0 د.م", icon: TrendingUp }
  ]);
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        // Update stats
        setStats([
          { title: "إجمالي العملاء", value: clientsCount.toString(), icon: Users },
          { title: "القضايا النشطة", value: activeCases.length.toString(), icon: Briefcase },
          { title: "المستندات", value: documentsCount.toString(), icon: FileText },
          { title: "الإيرادات", value: totalRevenue.toLocaleString('en') + " د.م", icon: TrendingUp }
        ]);
    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">نظرة شاملة على أداء مكتب المحاماة</p>
        </div>
        ...
        <Card className="lg:col-span-2 luxury-card">
          ...
          <CardContent>
            {loading ? (
              ...
              <p className="text-center text-muted-foreground py-8">لا توجد قضايا</p>
            ) : (
              <div className="space-y-4">
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            >
              ...
              <span className="text-sm font-medium">مستند جديد</span>
            </Button>
            <Button
              variant="outline"
              className="h-24 flex flex-col gap-2 hover:bg-accent/10 hover:border-accent transition-all"
